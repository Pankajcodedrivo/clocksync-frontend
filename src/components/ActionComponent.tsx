...
export default function ActionComponent({ game,teamName, socketEmit }: Props) {
    const [showPenaltyPopup, setShowPenaltyPopup] = useState(false);
    const [showPlayerList, setShowPlayerList] = useState(false);
    const [selectedEventType, setSelectedEventType] = useState("");
    const resolvedTeamName = teamName === "home" ? game.homeName : game.awayName;
  ...
  return (
    <>
        <div className="event-action-wrap">
            ...
            {/* Shot On */}
            <button className="btn" onClick={() => handleOtherClick("Shot On")}>
                <img src={icRoundAdjust} alt="Shot On" /> Shot On
            </button>

            {/* Shot Off */}
            <button className="btn" onClick={() => handleOtherClick("Shot Off")}>
            ...
            {/* TO-F */}
            <button className="btn" onClick={() => handleOtherClick("TO - F")}>
                <img src={icRoundAdjust} alt="TO - F" /> TO - F
            </button>

            {/* TO-U */}
            <button className="btn" onClick={() => handleOtherClick("TO - U")}>
